...
const CreatePost = () => {
  ...
  if(form.prompt && form.photo){
    ...
    alert('Molim Vas unesete informacije kako bi se slika generisala');
  }
  }
...
setForm({...form, prompt:randomPrompt})
  ...
  return (
    <section className='max-w-7xl mx-auto'>
        <div>
            <h1 className='font-extrabold text-[#222328] text-[32px]'>Izradi</h1>
            <p className='mt-2 text-[#666e75] text-[16px] max-w[500px]'>Izradi kolekciju imaginarninih i očaravajućih slika , a pomoći će ti DALL-E</p>
        ...
        <form className='mt-16 max-w-3xl' onSubmit={handleSubmit}>
          ...
          <div className='mt-5 flex gap-5'>
            ...
            >{generatingImg ? 'Generiram...' : 'Generiraj'}</button>
          </div>
          <div className='mt-10'>
            <p className='mt-2 text-[#666e75] text-[14px]'>Kad kreiraš sliku, mozes je podijeliti s drugima</p>
            <button
            type='submit'
            className='mt-3 text-white bg-[#6469ff] font-medium rounded-md
            text-sm w-full sm:w-auto px-5 py-2.5 text-center'
            >
              {loading ? 'Dijelim...' : 'Podijeli s drugima'}
            </button>
          </div>
        </form>
    </section>
